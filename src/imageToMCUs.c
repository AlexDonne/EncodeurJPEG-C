...
MCUPixelsRGB *imageCouleurToMCUs(ImagePPM *image, int *taille) {
    ...
    *taille = image->hauteur * image->largeur / 64;
...
//MCUPixelsNB* imageNBToMCUs(ImagePPM* image){
//    if (image->largeur % 8 != 0 || image->hauteur % 8 != 0) {
//        //Fonction qui règle problème
//        exit(1);
//    }
//    MCUPixelsNB *tableauMCUs;
//    int taille = image->hauteur * image->largeur / 64;
//    tableauMCUs = malloc(taille * sizeof(MCUPixelsNB));
//    int debcolbase = 0;
//    int deblignebase = 0;
//    int debligne;
//    int finligne = 8;
...
//    }
//
//    afficherMCUsNB(tableauMCUs, taille);
//    return tableauMCUs;
//}
...
//void afficherMCUsNB(MCUPixelsNB *tabMcus, int taille) {
//    for (int i = 0; i < taille; i++) {
//        printf("MCU #%d\n", i);
//        afficherMCU(tabMcus[i]);
//        printf("\n\n");
...
//}
//
//void afficherMCUNB(MCUPixelsNB mcu) {
//    for (int i = 0; i < 64; i++) {
//        printf("%x ", mcu.blocsN[i]);
//    }
//}